...
import com.renovation.guardian.data.knowledge.DefaultHouse
import com.renovation.guardian.data.knowledge.DoorBrand
import com.renovation.guardian.data.knowledge.DoorSeries
import com.renovation.guardian.data.knowledge.IdLabel
import com.renovation.guardian.data.knowledge.MainMaterial
import com.renovation.guardian.data.knowledge.MainMaterialType
import com.renovation.guardian.data.knowledge.MaterialSpec
import com.renovation.guardian.data.knowledge.MaterialVariant
import com.renovation.guardian.data.knowledge.OpeningSize
    ...
    private val catalog = DecoboxCatalogJson(
        ...
        doors = listOf(
            DoorBrand(
                ...
                customOpening = true,
                surcharge = com.renovation.guardian.data.knowledge.DoorSurcharge(
        ...
        windowsillEdges = listOf(com.renovation.guardian.data.knowledge.WindowsillEdge("round", "圆边", 0)),
        windowsillDefaults = com.renovation.guardian.data.knowledge.WindowsillDefaults(1.5, 3, 3),
        ...
        spaceExtras = listOf(
            com.renovation.guardian.data.knowledge.SpaceExtra("waterproof", "防水工程", "area", "m2", 65),
            com.renovation.guardian.data.knowledge.SpaceExtra("pipeWrap", "包管", "count", "根", 380),
        ),
    )
