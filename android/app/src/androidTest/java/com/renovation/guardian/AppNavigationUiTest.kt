...
class AppNavigationUiTest {
    ...
    fun fileProviderAllowsReadingTheGeneratedImage() {
        ...
        try {
            val uri = com.renovation.guardian.util.ImageShareUtil.cacheBitmap(context, bitmap, "instrumented-${java.util.UUID.randomUUID()}")
            ...
            if (android.os.Build.VERSION.SDK_INT >= 29) {
                gallery = com.renovation.guardian.util.ImageShareUtil.saveToGallery(context, bitmap, "validation-${java.util.UUID.randomUUID()}")
    ...
    fun documentExportClosesTheRealProviderStreamBeforeSuccess() {
        val context = ApplicationProvider.getApplicationContext<RenovationApp>()
        val vm = com.renovation.guardian.ui.nav.FileActionsViewModel(context, androidx.lifecycle.SavedStateHandle())
        ...
        try {
            ...
            org.junit.Assert.assertTrue(result is com.renovation.guardian.ui.nav.FileActionResult.Success)
