        ...
        LazyColumn(
            ...
            items(stages, key = { it.id }) { stage ->
                ...
                if (expanded) {
                    ...
                    StageDetailContent(detail = detail, vm = vm)
                }
            }
        }
    }
...
@Composable
private fun StageDetailContent(detail: StageDetailUi, vm: StagesViewModel) {
    ...
    Column(modifier = Modifier.padding(top = 8.dp)) {
        ...
        detail.customTasks.forEach { c ->
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                IconButton(onClick = { vm.deleteCustom(c.id) }) {
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            IconButton(onClick = { vm.addCustom(detail.stage.id, newTask); newTask = "" }) {
